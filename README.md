...
What I need to do: /newline
Add automatic recomputation of the algorithm if start/end node is changed or if any walls are added. DONE  
...
Host the project on github. DONE  
